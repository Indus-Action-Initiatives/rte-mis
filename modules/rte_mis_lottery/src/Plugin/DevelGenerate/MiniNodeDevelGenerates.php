...
class MiniNodeDevelGenerates extends DevelGenerateBase implements ContainerFactoryPluginInterface {
  ...
  public function batchCreateMiniNodes(array $values, array &$context): void {
    $num_per_batch = 1000;  // Number of nodes to create per batch.
  ...
  private function createMiniNode(): void {
    $values = [
      ...
      // 'field_select' => $this->generateRandomSelectValue(),
      // 'field_reference' => $this->generateRandomReference(), // Add actual implementation.
    ];
  ...
  /**
   * Generates a random entity reference.
   */
  private function generateRandomReference() {
    // Logic to generate a random reference, e.g., to a taxonomy term or another entity.
  }
